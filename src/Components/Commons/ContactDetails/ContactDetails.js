  ...
  const sendEmail = () => {
    ...
    axios({
      ...
      .catch((error) => {
        ...
        const message_ = error?.response?.data?.message
  ...
  return (
    <div id="Contact_ID" style={{ backgroundColor: Colors.newVar.BGColor }}>
      <Box className="ContactWrapper">
        <Grid
          className="ContactDetailsAndForm"
          container
          spacing={2}
          alignItems={"center"}
          direction={screenDimensions.width < 600 ? "column" : "row"}
        >
          <Grid
            display={"flex"}
            sx={{ width: "45%" }}
          ...
          >
            <div
              ...
              className={`ContactDetails ${
                SocialIconsVisible ? "FadeYAnimationContact" : ""
              }`}
            >
              <div className="CommonClass">
                <a
                  href={`tel:9175098814`}
                  className={
                    Colors.isDarkMode ? "CallMeIcon" : "CallMeIconLight"
                  }
                >
                  <Call
                    className="CallIcon"
                ...
                <span
                  style={{ color: Colors.newVar.TXTColor, marginLeft: 20 }}
                  className={"MailMeText"}
                >
                  +91 915098814
                </span>
              </div>
              <div className="CommonClass">
                <a
                  href="mailto:sahillokhande94@gmail.com?subject=Referred from your Developer Portfolio."
                  className={
                    Colors.isDarkMode ? "CallMeIcon" : "CallMeIconLight"
                  }
                >
          ...
          >
            <div
              ...
              className={`ContactForm ${
                ContactFormVisible ? "FadeYAnimationContact" : ""
              }`}
              style={{
                marginTop: screenDimensions.width < 600 ? "20%" : "5%",
                paddingBottom: "5%",
                marginLeft: "10%",
                marginBottom: screenDimensions.width < 600 && "20%",
              }}
            >
              <form action="" ref={form} onSubmit={OnSendClick}>
                ...
                <div
                  id={"emailInputdiv"}
                  style={{
                    borderBottomColor: NameError != null ? "red" : "orange",
                  }}
                >
                  <input
                    type={"text"}
                  ...
                  <AccountCircle
                    style={{
                      color: NameError != null ? "red" : "#1d1d1d",
                      fontSize: screenDimensions.width < 1000 ? 25 : 30,
                    }}
                  />
                </div>
                <div
                  id={"messageInputdiv"}
                  style={{
                    borderBottomColor: messageError != null ? "red" : "orange",
                  }}
                >
                  <textarea
                    value={message}
                    ...
                    maxLength={500}
                    style={{ color: "#1d1d1d", resize: "none" }}
                    rows={screenDimensions.width < 1000 ? 3 : 5}
                    cols={6}
                    onChange={(text) => {
                  ...
                  <Message
                    style={{
                      color: messageError != null ? "red" : "#1d1d1d",
                      fontSize: screenDimensions.width < 1000 ? 25 : 30,
                    }}
                  />
                </div>
                <div
                  id={"emailInputdiv"}
                  style={{
                    borderBottomColor: EmailError != null ? "red" : "orange",
                  }}
                >
                  <input
                    type={"email"}
                  ...
                  {EmailError != null ? (
                    <Error
                      ...
                      className={
                        "EmailErrorIcon animate__animated animate__shakeX animate__fast"
                      }
                    />
                  ) : (
                    <Mail
