...
const MPulseImages = [Images.MPulseImage1, Images.MPulseImage2, Images.MPulseImage3, Images.MPulseImage4, Images.MPulseImage6, Images.MPulseImage7, Images.MPulseImage8, Images.MPulseImage9, Images.MPulseImage11, Images.MPulseImage12]
      ...
      <div className='ActivityWrapper' id='Extra_ID' >
        ...
        <Grid className='PhotosContainer' justifyContent={'center'} container spacing={5} >
          {ImagesArr.map((item) => {
            return (
              <Grid item md={4} lg={3}>
                <img className='ImageCLass' src={item} alt="" style={{height:200, width:275, objectFit:'cover'}} />
              </Grid>
            )
          })}
        </Grid>
